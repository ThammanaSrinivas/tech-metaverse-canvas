...
export const RESUME_URL = 'https://drive.google.com/file/d/1dl6EqMYEaTCljbrqoKPbaH48pccvPxcX/view?usp=sharing';
...
const ResumeButton: React.FC<ResumeButtonProps> = ({ className = '', size = 'lg', variant = 'outline' }) => (
  <Button
    variant={variant}
    size={size}
